...
fun RiesgosScreen(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(
            text = "Tipos de riesgos en proyectos CSS",
        ...
        Text(
            text = "Identificar peligros y aplicar controles según la naturaleza del riesgo.",
        ...
        FlowRow(
            ...
            ContentRepository.riesgosItems.forEach { item ->
